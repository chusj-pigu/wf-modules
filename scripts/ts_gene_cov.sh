...
cat > "${output}.conf" <<EOF
{
	...
	},
	{
		...
		"label": "18h Coverage",
		"label_rotate": false,
		"file": "${bam%.indexed.bam}_0h_18h.indexed.bam",
		"color": "#888888",
		"n_bins": "5000",
		"scale": "custom",
		"scale_max": 250,
	...
	},
	{
		...
		"label": "12h Coverage",
		"label_rotate": false,
		"file": "${bam%.indexed.bam}_0h_12h.indexed.bam",
		"color": "#888888",
		"n_bins": "5000",
		"scale": "custom",
		"scale_max": 250,
	...
	},
	{
		...
		"label": "6h Coverage",
		"label_rotate": false,
		"file": "${bam%.indexed.bam}_0h_6h.indexed.bam",
		"color": "#888888",
		"n_bins": "5000",
		"scale": "custom",
		"scale_max": 250,
	...
	},
	{
		...
		"label": "3h Coverage",
		"label_rotate": false,
		"file": "${bam%.indexed.bam}_0h_3h.indexed.bam",
		"color": "#888888",
		"n_bins": "5000",
		"scale": "custom",
		"scale_max": 250,
	...
	},
	{
		...
		"label": "1h Coverage",
		"label_rotate": false,
		"file": "${bam%.indexed.bam}_0h_1h.indexed.bam",
		"color": "#888888",
		"n_bins": "5000",
		"scale": "custom",
		"scale_max": 250,
