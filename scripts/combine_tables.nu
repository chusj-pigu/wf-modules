...
def main [
        ...
        let df_combined = $df_per_feature |
            ...
            polars select "name" "chrom" "count_a" "count_valid_a" "percent_a" "Total A" "Min Read Length" "Max Read Length" "Mean Read Length" "Low >=0.25" "High >=0.75" "Med >=0.50" "V Low / Unmodified <0.25" "Intronic" "Non-Intronic" |
            polars collect
